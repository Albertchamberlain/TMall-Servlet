...
public class BackServletFilter  implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if(uri.startsWith("/admin/")){
            ...
            method = "".equals(method)?"list":method;
            ...
            if(user!=null && !flag) {
                if (user.getGroup()!=null && ("admin".equals(user.getGroup()) || "superAdmin".equals(user.getGroup()))) {
            ...
            if(user!=null && user.getGroup()!=null && flag){
                if (user.getGroup()!=null && "superAdmin".equals(user.getGroup())){
                    request.getRequestDispatcher(servletPath).forward(request, response);
                    return;
                }else {
